...
Every password listed in step 3 unlocks the site. To add, change or drop one, rerun step 3 with the new list. Each person types the password once per device and it's remembered after that. Start → Log Off forgets it.
